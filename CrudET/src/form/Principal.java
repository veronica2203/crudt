...
//            model=new DefaultTableModel(null,Titulos);   
    ...
    try {
        ...
        e.printStackTrace(); // Imprimir información detallada sobre la excepción
    }
}
    ...
    try {
        ...
        while (rs.next()) {
            ...
            Object[] fila = {id, dni, nom};
            model.addRow(fila);
        }

        TablaDatos.setModel(model); // Asigna el modelo de tabla a la JTable
